...
More specifically, Barr and Wells first formalize the diagram as a graph homomorphism, where domain is called shape graph. 
...
The definition of diagram becomes interesting once the concept of 'model' 
