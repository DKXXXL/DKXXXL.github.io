...
> 
> There is a function $i:A \rightarrow |M(A)|$, and given any monoid $N$ and any function $f: A \rightarrow |N|$, there is a $f'$, s.t., $|f'| \circ i = f$ , all as indicated in the following diagram:

How to understand this? This long, abstract definition? This is actually a pretty standard math language but those arrows make people confused. From Curry-Howard-Corrsepondence, we know every propositional 
